...
// Handle form submissions for customers CRUD operations
    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add':
                ...
                $sql = "INSERT INTO customers (customer_name, contact_person, contact_email, contact_phone, address, city, state, postal_code, country, notes) 
                        VALUES ('$customer_name', '$contact_person', '$contact_email', '$contact_phone', '$address', '$city', '$state', '$postal_code', '$country', '$notes')";
            ...
            case 'edit':
                ...
                $sql = "UPDATE customers SET customer_name='$customer_name', contact_person='$contact_person', 
    ...
    <body class="sb-nav-fixed">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input class="form-control" id="customerName" name="customer_name" type="text" required />
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-warning" onclick="editCustomer(<?php echo htmlspecialchars(json_encode($row)); ?>)">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-danger" onclick="deleteCustomer(<?php echo $row['customer_id']; ?>)">
                    ...
                    <form method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class="form-control" id="editCustomerName" name="customer_name" type="text" required />
        ...
        <script>
            function editCustomer(customer) {
                ...
                document.getElementById('editContactEmail').value = customer.contact_email || '';
                document.getElementById('editContactPhone').value = customer.contact_phone || '';
                document.getElementById('editAddress').value = customer.address || '';
                document.getElementById('editCity').value = customer.city || '';
                document.getElementById('editState').value = customer.state || '';
                document.getElementById('editPostalCode').value = customer.postal_code || '';
